        ...
        <div className="space-y-6">
            ...
            <Card>
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 items-end">
                    <div className="flex-1 w-full space-y-4 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-4">
                        ...
                        <div className="w-full relative">
                            ...
                            {selectedMunicipio ? (
                                <div className="flex items-center justify-between w-full rounded-md border border-slate-300 p-2 bg-slate-50">
                                    <span className="text-slate-900">{selectedMunicipio.nomeCompleto}</span>
                                    <button
                                        type="button"
                                        onClick={() => {
                                            setSelectedMunicipio(null)
                    ...
                    <table className="w-full text-left">
                        <thead className="bg-slate-50 border-b border-slate-200">
                            <tr>
                                ...
                                <th className="p-4 font-semibold text-slate-600 w-40">Criado em</th>
                            ...
                            {loading ? (
                                ...
                                licitacoes.map((lic) => (
                                    <tr key={lic.id} className={`hover:bg-slate-50 transition-colors ${editId === lic.id ? 'bg-blue-50' : ''}`}>
                                        ...
                                        <td className="p-4 text-slate-500">{new Date(lic.createdAt).toLocaleDateString('pt-BR')}</td>
